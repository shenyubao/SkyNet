...
import com.weibo.vip.skynet.util.CommonUtil;
...
public class WebServer extends Thread {
    ...
    private ExecutorService pool; //进程池
    ...
    public void run(){
    	try {
    		...
    		if(NetUtil.isLocalPortInUse(port)){
    			if (mListener != null) {
            ...
            params.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 5000)
            	  ...
            	  .setParameter(CoreProtocolPNames.ORIGIN_SERVER, "SkyNetServer/1.1");
            	  
            httpService.setParams(params);
    		
            // 增加HTTP请求执行器
            HttpRequestHandlerRegistry reqistry = new HttpRequestHandlerRegistry();
            reqistry.register("/upload", new HttpUpHandler());
            reqistry.register("*", new HttpHandler(VipApplication.getInstance().getApplicationContext()));
