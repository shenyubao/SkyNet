...
public class WorkerThread extends Thread{
    ...
    public WorkerThread(HttpService httpservice, HttpServerConnection conn,OnWebServListener listener) {
        super();
    ...
    public void run() {
    	 ...
    	 try {
            ...
            if (DEBUG) System.err.println("Client closed connection");		
        } catch (IOException e) {
        	if (DEBUG) {
			...
			if(DEBUG) System.err.println("Unrecoverable HTTP protocol violation: " + e.getMessage());
		} finally{
			try {
                this.conn.shutdown();
