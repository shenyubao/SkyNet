...
import com.weibo.vip.skynet.ui.WebServerActivity;
...
public class WebService extends Service implements OnWebServListener{
    ...
    private static final int RESUME_COUNT = 2;
    ...
    public void onCreate() {
        super.onCreate();
        if (DEBUG) Log.d(TAG,String.format("create server: port=%d, root=%s", Constants.PORT, Constants.WEBROOT));
        webServer = new WebServer(Constants.PORT, Constants.WEBROOT);
    ...
    private void showNotification(int resId, int iconId) {
        ...
        PendingIntent contentIntent = PendingIntent.getActivity(this, 0, new Intent(this,WebServerActivity.class), 0);
